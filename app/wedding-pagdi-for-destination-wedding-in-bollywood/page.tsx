...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bollywoodsafawala.com/wedding-pagdi-for-destination-wedding-in-bollywood",
    type: "website",
  },
}
...
export default function WeddingPagdiForDestinationWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India"],

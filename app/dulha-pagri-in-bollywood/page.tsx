...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bollywoodsafawala.com/dulha-pagri-in-bollywood",
    type: "website",
  },
}
...
export default function DulhaPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagri specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit"],

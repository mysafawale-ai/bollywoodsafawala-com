...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bollywoodsafawala.com/sehrabandi-in-bollywood",
    type: "website",
  },
}
...
export default function SehrabandiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert sehra specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders"],

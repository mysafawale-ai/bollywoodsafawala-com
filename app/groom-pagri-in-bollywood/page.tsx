...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bollywoodsafawala.com/groom-pagri-in-bollywood",
    type: "website",
  },
}
...
export default function GroomPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "Expert pagri specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations"],

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bollywoodsafawala.com/wedding-pagri-in-bollywood",
    type: "website",
  },
}
...
export default function WeddingPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagri specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],

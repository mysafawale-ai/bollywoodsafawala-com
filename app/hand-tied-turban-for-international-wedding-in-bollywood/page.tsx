...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bollywoodsafawala.com/hand-tied-turban-for-international-wedding-in-bollywood",
    type: "website",
  },
}
...
export default function HandTiedTurbanForInternationalWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Expert turban specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],

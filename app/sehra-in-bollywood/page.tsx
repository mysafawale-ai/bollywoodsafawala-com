...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bollywoodsafawala.com/sehra-in-bollywood",
    type: "website",
  },
}
...
export default function SehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination"],

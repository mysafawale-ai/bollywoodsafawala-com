...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bollywoodsafawala.com/safa-tying-service-in-bollywood",
    type: "website",
  },
}
...
export default function SafaTyingServiceInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination"],
